 ...
 */
class DatabaseRecordListHook implements \TYPO3\CMS\Recordlist\RecordList\RecordListHookInterface {
...
if (defined('TYPO3_MODE') && isset($GLOBALS['TYPO3_CONF_VARS'][TYPO3_MODE]['XCLASS']['ext/gridelements/hooks/class.tx_gridelements_db_list_extrahook.php'])) {
	include_once($GLOBALS['TYPO3_CONF_VARS'][TYPO3_MODE]['XCLASS']['ext/gridelements/lib/class.tx_gridelements_db_list_extrahook.php']);
}
