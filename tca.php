...
$TCA['tx_gridelements_backend_layout'] = array(
	...
	'columns' => array(
		...
		'hidden' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:gridelements/locallang_db.xml:tx_gridelements_backend_layout',
			'config' => array(
				'type' => 'check',
				'items' => array (
					'1'	=> array(
		...
		'pi_flexform_ds_file' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:gridelements/locallang_db.xml:tx_gridelements_backend_layout.pi_flexform_ds_file',
			'config' => array(
				'type' => 'group',
				'internal_type' => 'file',
				'allowed' => 'xml',
