...
class tx_gridelements_itemsprocfunc_colPosList extends tx_gridelements_itemsprocfunc_abstract {
...
if (defined('TYPO3_MODE') && isset($GLOBALS['TYPO3_CONF_VARS'][TYPO3_MODE]['XCLASS']['ext/gridelements/lib/class.tx_gridelements_itemsprocfunc_colposlist.php'])) {
	include_once($GLOBALS['TYPO3_CONF_VARS'][TYPO3_MODE]['XCLASS']['ext/gridelements/lib/class.tx_gridelements_itemsprocfunc_colposlist.php']);
}
?>